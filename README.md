...
🎤 Speaker @ TPM Summit | TPM Trails Organiser in Madrid, New York, Munich | Community Builder
...
## 💡 Skills & Expertise
- **Technical Program Management:** Portfolio & roadmap execution across multi-team, multi-site orgs; program governance; end-to-end delivery from strategy
- **Scaling Product, CTO Office & TPM organsiations:** Building and leading global TPM teams; operating models, rituals, and standards; mentoring & career development
- **AI & Automation for TPMs & Product & Engineering Organsiations:** From summarization to rolling out AI TPM Buddies for Onboarding, Monthly reporting, or Risk Management
...
- **GitHub:** [@michigoetz](https://github.com/michigoetz)
- **Substack:** [@michigoetz](https://substack.com/@michigoetz?)
- **E-Mail** - Ask for it

## 🎉 Fun Facts
- Grow up in the Bavarian countryside in Germany, relocated to NYC in 2024.
- Paragliding license in place, decided to go for sailing instead.
- Expert in drawing animals for my daughter.
- Organise events from TPMs in NYC, Madrid and Munich

## 🤝 Open to Collaboration
I spent time in the Bay Area in 2019 in order to deep dive into the tech industry and the Technical Program Management role specifically. Got to know so many great people and eager to give back to the community - let's connect!
